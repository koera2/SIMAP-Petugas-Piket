...
<?php  
	if (isset($_POST['tampil'])) { 
			...
			$link_print = "piket/kinerja/export/format_print_rayon.php?rayonS&kd_rayon=".$kd_rayon."&semester=".$semester."&tp=".$tpel;
			$link_pdf = "piket/kinerja/export/format_pdf.php?rayonS&kd_rayon=".$kd_rayon."&semester=".$semester."&tp=".$tpel;
			$link_excel = "piket/kinerja/export/format_excel.php?rayonS&kd_rayon=".$kd_rayon."&semester=".$semester."&tp=".$tpel;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Kinerja Siswa Rayon <?php echo $ryn['rayon']; ?> Semester <?php echo $semester." Tahun Pelajaran ".$tpel; ?></div>
