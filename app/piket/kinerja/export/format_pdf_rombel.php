<?php  
	...
	if (isset($_GET['rombelM'])) {
		...
		$nama = "Laporan Kinerja Siswa Rombel ".$rombel." Bulan ".$bulan." ".$tahun.".pdf";
		...
		$sum = "nis,nama,rombel,kode_rayon,SUM(skor_r) as skor_reward, SUM(skor_p) as skor_punishment";
		$data = $aksi->tampil_sum($sum,$table,$where,"GROUP BY nis ORDER BY nis ASC");
		$nama = "Laporan Kinerja Siswa Rombel ".$rombel." Periode ".$dari." sampai ".$sampai.".pdf";
		...
		$sum = "nis,nama,rombel,kode_rayon,SUM(skor_r) as skor_reward, SUM(skor_p) as skor_punishment";
		$data = $aksi->tampil_sum($sum,$table,$where,"GROUP BY nis ORDER BY nis ASC");
		$nama = "Laporan Kinerja Siswa Rombel ".$rombel." Semester ".$semester." tp ".$tpel.".pdf";
	}
?>
<!DOCTYPE html>
<html>
