...
<?php  
	if (isset($_POST['tampil'])) { 
			...
			$link_print = "piket/kinerja/export/format_print_rayon.php?rayon&kd_rayon=".$kd_rayon;
			$link_pdf = "piket/kinerja/export/format_pdf.php?rayon&kd_rayon=".$kd_rayon;
			$link_excel = "piket/kinerja/export/format_excel.php?rayon&kd_rayon=".$kd_rayon;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Kinerja Siswa Rayon <?php echo $ryn['rayon']; ?></div>
		                	...
		                	<?php  
		                		...
		                		<?php }else{	
			                		foreach ($data as $r) {
				                		...
				                		$link_detail = "piket/kinerja/export/format_print_siswa.php?nis=".$r['nis'];
			                		 ?>
			                		 	<tr>
					             			<td><?php echo $no; ?>.</td>
															...
															<div class="modal-header">
																...
																<table class="table table-bordered table-striped table-hover">
																	...
																	<tbody>
																		<?php  
																			$no_detail_r = 0;
																			$where_detail_r = "WHERE nis = '$r[nis]' AND kelompok_kinerja = 'REWARD'";
															...
															<div class="modal-header">
																...
																<table class="table table-bordered table-striped table-hover">
																	...
																	<tbody>
																		<?php  
																			$no_detail_p = 0;
																			$where_detail_p = "WHERE nis = '$r[nis]' AND kelompok_kinerja = 'PUNISHMENT'";
