...
<?php  
	if (isset($_POST['tampil'])) { 
			...
			$link_print = "piket/kinerja/export/format_print_rayon.php?rayonP&kd_rayon=".$kd_rayon."&dari=".$dari."&sampai=".$sampai;
			$link_pdf = "piket/kinerja/export/format_pdf.php?rayonP&kd_rayon=".$kd_rayon."&dari=".$dari."&sampai=".$sampai;
			$link_excel = "piket/kinerja/export/format_excel.php?rayonP&kd_rayon=".$kd_rayon."&dari=".$dari."&sampai=".$sampai;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Kinerja Siswa Rayon <?php echo $ryn['rayon']; ?> Periode <?php $aksi->format_tanggal($dari);echo " - ";$aksi->format_tanggal($sampai); ?></div>
