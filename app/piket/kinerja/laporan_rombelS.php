...
<?php  
	if (isset($_POST['tampil'])) { 
		$link_print = "piket/kinerja/export/format_print_rombel.php?rombelS&rombel=".$kd_rombel."&semester=".$semester."&tp=".$tpel;
		$link_pdf = "piket/kinerja/export/format_pdf.php?rombelS&rombel=".$kd_rombel."&semester=".$semester."&tp=".$tpel;
		$link_excel = "piket/kinerja/export/format_excel.php?rombelS&rombel=".$kd_rombel."&semester=".$semester."&tp=".$tpel;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Kinerja Siswa Rombel <?php echo $kd_rombel; ?> Semester <?php echo $semester." Tahun Pelajaran ".$tpel; ?></div>
		                	...
		                	<?php  
		                		...
		                		<?php }else{
			                		foreach ($data as $r) {
				                		...
				                		$link_detail = "piket/kinerja/export/format_print_detail.php?siswaS&nis=".$r['nis']."&semester=".$semester."&tp=".$tpel;
					             					...
					             					<div class="modal-dialog modal-lg modal-primary">
														<div class="modal-content">
															<div class="modal-header">
																...
																<h4 class="modal-title">Daftar Riwayat Reward : <?php echo $r['nama']." Semester ".$semester." Tahun Pelajaran ".$tpel; ?></h4>
															</div>
																...
																<table class="table table-bordered table-striped table-hover">
																	...
																	<tbody>
																		<?php  
																			$no_detail_r = 0;
																			$where_detail_r = "WHERE nis = '$r[nis]' AND kelompok_kinerja = 'REWARD' AND semester='$semester' AND tahun_pelajaran = '$tpel'";
					             				...
					             				<div class="modal fade" id="<?php echo $r['nis'];?>PUNISHMENT">
					             					<div class="modal-dialog modal-lg modal-primary">
														<div class="modal-content">
															<div class="modal-header">
																<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
																<h4 class="modal-title">Daftar Riwayat Punishment : <?php echo $r['nama']." Semester ".$semester." Tahun Pelajaran ".$tpel; ?></h4>
															</div>
																...
																<table class="table table-bordered table-striped table-hover">
																	...
																	<tbody>
																		<?php  
																			$no_detail_p = 0;
																			$where_detail_p = "WHERE nis = '$r[nis]' AND kelompok_kinerja = 'PUNISHMENT' AND semester='$semester' AND tahun_pelajaran = '$tpel'";
