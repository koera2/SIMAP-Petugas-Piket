	...
	<div id="wrapper">
		...
		<div id="judul">
			...
			<?php }elseif (isset($_GET['rayon'])) {?>
				<center><h4 style="margin-bottom: 15px;margin-top: 15px;"><strong><?php echo  $judul; ?></strong></h4></center>
			...
			<?php }else{?>
				<center><h4 style="margin-bottom: 15px;margin-top: 15px;"><strong><?php echo  $judul." SEMESTER ".$semester." TAHUN PELAJARAN ".$tpel; ?></strong></h4></center>
			<?php } ?>
		</div>
