<?php  
	...
	if (isset($_GET['rombelM'])) {
		...
		$nama = "Laporan Izin Siswa Rombel ".$rombel." Bulan ".$bulan." ".$tahun.".pdf";
		...
		$sum = "nis,nama,rombel,kode_rayon,COUNT(jenis_izin) as jumlah_izin";
		$data = $aksi->tampil_sum($sum,$table,$where,"GROUP BY nis ORDER BY nis ASC");
		$nama = "Laporan Izin Siswa Rombel ".$rombel." Periode ".$dari." sampai ".$sampai.".pdf";
		...
		$sum = "nis,nama,rombel,kode_rayon,COUNT(jenis_izin) as jumlah_izin";
		$data = $aksi->tampil_sum($sum,$table,$where,"GROUP BY nis ORDER BY nis ASC");
		$nama = "Laporan Izin Siswa Rombel ".$rombel." Semester ".$semester." tp ".$tpel.".pdf";
	}
?>
<!DOCTYPE html>
<html>
