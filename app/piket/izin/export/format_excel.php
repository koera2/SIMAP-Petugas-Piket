<?php  
	...
	if (isset($_GET['rombelM']) OR isset($_GET['rombelP']) OR isset($_GET['rombelS'])) {
		...
		if (isset($_GET['rombelM'])){
			$nama = "Laporan Izin Siswa Rombel ".$kd_rombel." Bulan ".$bulan." ".$tahun.".xls";
		}elseif (isset($_GET['rombelP'])){
			$nama = "Laporan Izin Siswa Rombel ".$kd_rombel." Periode ".$dari." sampai ".$sampai.".xls";
		}elseif (isset($_GET['rombelS'])){
			$nama = "Laporan Izin Siswa Rombel ".$kd_rombel." Semester ".$semester." tp ".$tpel.".xls";
		}
		...
		if (isset($_GET['rayonM'])){
			$nama = "Laporan Izin Siswa Rayon ".$rayon." Bulan ".$bulan." ".$tahun.".xls";
		}elseif (isset($_GET['rayon'])){
			$nama = "Laporan Izin Siswa Rayon ".$rayon.".xls";
		}elseif (isset($_GET['rayonP'])){
			$nama = "Laporan Izin Siswa Rayon ".$rayon." Periode ".$dari." sampai ".$sampai.".xls";
		}elseif (isset($_GET['rayonS'])){
			$nama = "Laporan Izin Siswa Rayon ".$rayon." Semester ".$semester." tp ".$tpel.".xls";
		}
	}elseif(isset($_GET['siswa'])){
		$inc = "format_excel_siswa.php";
		$nama = "Laporan Izin - ".$_GET['nis'].".xls";
	}elseif(isset($_GET['alasan'])){
		$inc = "format_excel_grafik.php";
	    $nama = "Laporan Alasan Siswa Izin Periode ".$dari." sampai ".$sampai.".xls";
	}
