...
<?php  
	if (isset($_POST['tampil'])) { 
			$link_print = "piket/izin/export/format_print_rombel.php?rombelP&rombel=".$kd_rombel."&dari=".$dari."&sampai=".$sampai;
			$link_pdf = "piket/izin/export/format_pdf.php?rombelP&rombel=".$kd_rombel."&dari=".$dari."&sampai=".$sampai;
			$link_excel = "piket/izin/export/format_excel.php?rombelP&rombel=".$kd_rombel."&dari=".$dari."&sampai=".$sampai;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Izin Siswa Rombel <?php echo $kd_rombel; ?> Periode <?php $aksi->format_tanggal($dari);echo " - ";$aksi->format_tanggal($sampai); ?></div>
					...
					<table id="example1" class="table table-bordered table-hover table-striped">
		                ...
		                <tbody>
		                	<?php  
		                		...
		                		$where = "WHERE rombel = '$kd_rombel' AND tgl_izin BETWEEN '$dari' AND '$sampai'";
