...
<?php  
	if (isset($_POST['tampil'])) { 
			$link_print = "piket/izin/export/format_print_rombel.php?rombelM&rombel=".$kd_rombel."&bulan=".$bulan."&tahun=".$tahun;
			$link_pdf = "piket/izin/export/format_pdf.php?rombelM&rombel=".$kd_rombel."&bulan=".$bulan."&tahun=".$tahun;
			$link_excel = "piket/izin/export/format_excel.php?rombelM&rombel=".$kd_rombel."&bulan=".$bulan."&tahun=".$tahun;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Izin Siswa Rombel <?php echo $kd_rombel; ?> Bulan <?php $aksi->bulan($bulan);echo " ".$tahun; ?></div>
					...
					<table id="example1" class="table table-bordered table-hover table-striped">
		                ...
		                <tbody>
		                	<?php  
		                		...
		                		$where = "WHERE rombel = '$kd_rombel' AND MONTH(tgl_izin)='$bulan' AND YEAR(tgl_izin)='$tahun'";
