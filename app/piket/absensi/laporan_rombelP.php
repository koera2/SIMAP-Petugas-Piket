...
<?php  
	if (isset($_POST['tampil'])) {
		$link_print = "piket/absensi/export/format_print_rombel.php?rombelP&rombel=".$kd_rombel."&dari=".$dari."&sampai=".$sampai;
		$link_pdf = "piket/absensi/export/format_pdf.php?rombelP&rombel=".$kd_rombel."&dari=".$dari."&sampai=".$sampai;
		$link_excel = "piket/absensi/export/format_excel.php?rombelP&rombel=".$kd_rombel."&dari=".$dari."&sampai=".$sampai;
	 ?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Absensi Siswa Rombel <?php echo $kd_rombel; ?> Periode <?php $aksi->format_tanggal($dari);echo " - ";$aksi->format_tanggal($sampai); ?></div>
					...
					<table id="example1" class="table table-bordered table-hover">
		                ...
		                <tbody>
		                	<?php  
		                		...
		                		$where = "WHERE rombel = '$kd_rombel' AND tgl_absen BETWEEN '$dari' AND '$sampai'";
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header" id="pri">
														...
														<h4 class="modal-title">Daftar Riwayat Absensi : <?php echo $r['nama']." Periode ";$aksi->format_tanggal($dari);echo " - ";$aksi->format_tanggal($sampai); ?></h4>
													</div>
															...
															<table class="table table-striped table-bordered table-hover">
																...
																<tbody>
																	<?php  
																		...
																		$whr = "WHERE nis = '$r[nis]' AND tgl_absen BETWEEN '$dari' AND '$sampai'";
