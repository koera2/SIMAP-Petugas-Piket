...
<?php  
	if (isset($_POST['tampil'])) { 
		$link_print = "piket/absensi/export/format_print_rombel.php?rombelS&rombel=".$kd_rombel."&semester=".$semester."&tp=".$tpel;
		$link_pdf = "piket/absensi/export/format_pdf.php?rombelS&rombel=".$kd_rombel."&semester=".$semester."&tp=".$tpel;
		$link_excel = "piket/absensi/export/format_excel.php?rombelS&rombel=".$kd_rombel."&semester=".$semester."&tp=".$tpel;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Absensi Siswa Rombel <?php echo $kd_rombel; ?> Semester <?php echo $semester." Tahun Pelajaran ".$tpel; ?></div>
