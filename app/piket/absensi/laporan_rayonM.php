...
<?php  
	if (isset($_POST['tampil'])) { 
			...
			$link_print = "piket/absensi/export/format_print_rayon.php?rayonM&kd_rayon=".$kd_rayon."&bulan=".$bulan."&tahun=".$tahun;
			$link_pdf = "piket/absensi/export/format_pdf.php?rayonM&kd_rayon=".$kd_rayon."&bulan=".$bulan."&tahun=".$tahun;
			$link_excel = "piket/absensi/export/format_excel.php?rayonM&kd_rayon=".$kd_rayon."&bulan=".$bulan."&tahun=".$tahun;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Absensi Siswa Rayon <?php echo $ryn['rayon']; ?> Bulan <?php $aksi->bulan($bulan);echo " ".$tahun; ?></div>
