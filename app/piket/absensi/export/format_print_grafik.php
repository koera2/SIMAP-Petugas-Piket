...
<html>
<head>
    <title>Print Grafik Alasan</title>
...
<body onload="window.print()">
    <div id="wrapper">
        ...
        <div id="judul">
            <center><h4 style="margin-bottom: 10px;margin-top: 20px;"><strong>LAPORAN GRAFIK ALASAN SISWA TIDAK MASUK PERIODE <?php $aksi->tanggal_kapital($dari);echo " - ";$aksi->tanggal_kapital($sampai) ?></strong></h4></center>
        </div>
        ...
        <div id="isi">
            <div id="container" style="width:65%;"></div>
             <div id="judul">
                <center><h4 style="margin-bottom: 10px;margin-top: 20px;"><strong>DATA ALASAN SISWA TIDAK MASUK PERIODE <?php $aksi->tanggal_kapital($dari);echo " - ";$aksi->tanggal_kapital($sampai) ?></strong></h4></center>
            </div>
