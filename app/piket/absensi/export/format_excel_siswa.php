	...
	<div id="wrapper">
		...
		<div id="biodata">
			<table cellspacing="0" cellpadding="3" align="left">
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;Total Hadir</td>
					<td align="left">:&nbsp;<?php echo $total_hadir; ?></td>
					<td></td>
				</tr>
				<tr>
					<td></td>
					...
					<td align="left">:&nbsp;<?php echo $total_tdk_hadir; ?></td>
					<td></td>
				</tr>
			</table>
		</div>
		...
		<div id="tes">
			<table cellspacing="0" cellpadding="3" align="center">
				<tr>
					<td colspan="8" align="center">Hadir : <?php echo $total['jumlah_hadir']; ?>, Sakit : <?php echo $total['jumlah_sakit']; ?>, Izin : <?php echo $total['jumlah_izin']; ?>, Alpa : <?php echo $total['jumlah_alpa']; ?>, Tugas : <?php echo $total['jumlah_tugas']; ?></td>
				</tr>
			</table>
		</div>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="3" >
				<thead>
			    	<tr>
	            		...
	            		<th width="5%"><center>Alpa</center></th>
	            		<th width="5%"><center>Tugas</center></th>
			    	</tr>
			    </thead>
			    <tbody>
			    	<?php  
