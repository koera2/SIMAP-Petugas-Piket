			...
			<table width="100%" border="1" cellspacing="0" cellpadding="3" >
				<thead>
			    	<tr>
			    		...
			    		<th width="3%">JK</th>
			    		<th width="12%"><center>Rayon</center></th>
			    	...
			    	<?php  
			    		...
			    		if (empty($data)) {
			    			...
			    			foreach ($data as $r) {
	                			...
	                			$sakit = $aksi->tampil("tbl_absensi_siswa","WHERE nis = '$r[nis]' AND sakit = '1' AND ".$where_detail,"");
			    				$izin = $aksi->tampil("tbl_absensi_siswa","WHERE nis = '$r[nis]' AND izin = '1' AND ".$where_detail,"");
			    				$alpa = $aksi->tampil("tbl_absensi_siswa","WHERE nis = '$r[nis]' AND alpa = '1' AND ".$where_detail,"");
			    				$tugas = $aksi->tampil("tbl_absensi_siswa","WHERE nis = '$r[nis]' AND tugas = '1' AND ".$where_detail,"");
	                		 ?>
	                		 	<tr>
