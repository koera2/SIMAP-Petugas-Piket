				...
				<div class="nav-tabs-custom">
		            <ul class="nav nav-tabs">
		            	<li <?php if(isset($_GET['rombelM'])){echo "class=active";} ?>>
		            		<a href="?menu=absensi_laporan&rombelM"><center>Per-Rombel<br>(Bulan)</center></a>
		            	</li>
			            <li <?php if(isset($_GET['rombelS'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&rombelS"><center>Per-Rombel<br>(Semester)</center></a>
			            </li>
			            <li <?php if(isset($_GET['rombelP'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&rombelP"><center>Per-Rombel<br>(Periode)</center></a>
			            </li>
			            <li <?php if(isset($_GET['rayon'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&rayon"><center>Per-Rayon<br>(Semuanya)</center></a>
			            </li>
			             <li <?php if(isset($_GET['rayonM'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&rayonM"><center>Per-Rayon<br>(Bulan)</center></a>
			            </li>
						<li <?php if(isset($_GET['rayonS'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&rayonS"><center>Per-Rayon<br>(Semester)</center></a>
			            </li>
			            <li <?php if(isset($_GET['rayonP'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&rayonP"><center>Per-Rayon<br>(Periode)</center></a>
			            </li>
			            <li <?php if(isset($_GET['siswa'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&siswa"><center>Laporan<br>Persiswa</center></a>
			            </li>	
		              	<li <?php if(isset($_GET['alasan'])){echo "class=active";} ?>>
			            	<a href="?menu=absensi_laporan&alasan"><center>Laporan Alasan<br>Siswa Tidak Masuk</center></a>
			            </li>			            
		            </ul>
			            	...
			            	<div class="row">
			            		<?php
			            			if (isset($_GET['rombelM'])) {
		            			  		...
		            			  		$aksi->redirect("?menu=absensi_laporan&rombelM");
		            			  	}
			            		?>
			              	</div>
			            </div>
