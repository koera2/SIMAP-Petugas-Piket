...
<?php  
	if (isset($_POST['tampil'])) { 
			...
			$link_print = "piket/absensi/export/format_print_rayon.php?rayon&kd_rayon=".$kd_rayon;
			$link_pdf = "piket/absensi/export/format_pdf.php?rayon&kd_rayon=".$kd_rayon;
			$link_excel = "piket/absensi/export/format_excel.php?rayon&kd_rayon=".$kd_rayon;
		?>
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Laporan Absensi Siswa Rayon <?php echo $ryn['rayon']; ?></div>
					...
					<table id="example1" class="table table-bordered table-hover">
		                ...
		                <tbody>
		                	<?php  
		                		...
		                		if (empty($data)) {?>
		                			<tr><td></td><td></td><td></td><td></td><td></td><td align="center">Data Tidak Ada<td></td><td></td><td></td><td></td><td></td><td></td></tr>
		                		<?php }else{	
			                		foreach ($data as $r) {
			                			$no++;
			                			$siswa = $aksi->caridata("tbl_siswa WHERE nis = '$r[nis]'");
			                			$link_detail = "piket/absensi/export/format_print_siswa.php?nis=".$r['nis'];
			                		 ?>
			                		 	<tr>
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header" id="pri">
														...
														<h4 class="modal-title">Daftar Riwayat Absensi : <?php echo $r['nama'];?></h4>
													</div>
